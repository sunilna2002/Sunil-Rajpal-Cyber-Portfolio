# Sunil-Rajpal-Cyber-Portfolio
Cybersecurity portfolio featuring SIEM log analysis (Splunk), threat detection, and incident response projects. Includes a deep-dive investigation of 750k+ events.
...
- OS: Linux  
- Supporting: Python, SQL  

---

### 🚨 Key Findings
- Identified abnormal traffic patterns from multiple source IPs  
...
- Filtered high-volume IP traffic  
...
- Block or monitor suspicious IP ranges  
- Improve log monitoring thresholds  
